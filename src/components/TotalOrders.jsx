  ...
  return (
    <div className='m-4 bg-white rounded-xl'>
      <div className='flex justify-between p-10'>
        ...
        <h3 className='font-semibold'>A summary of your orders</h3>
        </div>
        <button className="btn bg-blue-900 text-white hover:text-black" onClick={handleViewAll}>View All</button>
      </div>
      <div className='ml-3'>
